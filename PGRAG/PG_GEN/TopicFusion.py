    ...
    def keyword_fusion(self):
        ...
        for topic1, keywords1 in topic_keywords.items():
            ...
            for topic2, keywords2 in topic_keywords.items():
                if topic1 != topic2 and len(keywords1 & keywords2) >= 3:  # 修改条件，至少两个关键词的重叠
